...
class REQ05ConsultarUsuarioMVC {

	private MockMvc mockMvc;

	@Test
	public void status0() throws Exception {
		ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/usuarios/consultar"));
	...
	public void verificaView0() throws Exception {
		...
		resultActions.andExpect(view.name("ConsultarUsuario"));
	}
